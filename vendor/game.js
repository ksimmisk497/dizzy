    ...
    if (filesByChar[char].length > 0) {
      filesByChar[char].forEach((file) => {
        ...
        btn.onclick = () => {
          ...
          if (typeof window.dizzyOpenGame === "function") {
            window.dizzyOpenGame(normalized, file);
            return;
          }
          ...
          (async function () {
            ...
            if (!text) {
              alert("Could not load game (CDN blocked). Try another network.");
              return;
            }
            if (typeof window.dizzyOpenGameHtml === "function") {
              window.dizzyOpenGameHtml(text, file);
              return;
            }
